...
<head>
  ...
  <style>
    ...
    .page-title { font-weight: 700; margin: 24px 0; color: #2b2f38; }
    .card-soft { background: #fff; border: none; border-radius: 14px; box-shadow: 0 4px 16px rgba(20,22,36,.06); }
    .card-section { margin-bottom: 18px; }
    .summary { padding: 20px; }
    .summary .avatar { width: 72px; height: 72px; border-radius: 50%; object-fit: cover; border: 3px solid #e9eef8; }
    .summary .name { font-size: 1.05rem; font-weight: 700; margin-bottom: 2px; }
    .summary .meta { color: #6b7280; font-size: .9rem; }
    .section-header { padding: 14px 16px; border-bottom: 1px solid #eef2f7; display: flex; align-items: center; justify-content: space-between; }
    .section-title { margin: 0; font-weight: 600; color: #334155; }
    .edit-btn { background: #ff8a3d; color: #fff; border: none; font-weight: 600; padding: 6px 10px; border-radius: 8px; }
    .info-grid { padding: 16px; }
    .info-label { color: #6b7280; font-size: .85rem; margin-bottom: 4px; }
